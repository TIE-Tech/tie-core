...
func (txn *Txn) SetStorage(
	...
	if legacyGasMetering {
		if oldValue == zeroHash {
			return evm.StorageAdded
		} else if value == zeroHash {
			txn.AddRefund(15000)

			return evm.StorageDeleted
		}

		return evm.StorageModified
	}
	...
	return evm.StorageModifiedAgain
}
