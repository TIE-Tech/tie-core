...
func (p *Precompiled) CanRun(c *evm.Contract, _ evm.Host, config *params.ForksInTime) bool {
...
func (p *Precompiled) Run(c *evm.Contract, _ evm.Host, config *params.ForksInTime) *evm.ExecutionResult {
