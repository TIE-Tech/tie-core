...
func (b *bn256Add) gas(input []byte, config *params.ForksInTime) uint64 {
	if config.Istanbul {
		return 150
	}
...
func (b *bn256Mul) gas(input []byte, config *params.ForksInTime) uint64 {
	if config.Istanbul {
		return 6000
	}
...
func (b *bn256Pairing) gas(input []byte, config *params.ForksInTime) uint64 {
