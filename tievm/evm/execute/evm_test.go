...
func (m *mockHost) GetTxContext() evm.TxContext {
	panic("Not implemented in tests")
}
...
func (m *mockHost) Callx(*evm.Contract, evm.Host) *evm.ExecutionResult {
	panic("Not implemented in tests")
}
